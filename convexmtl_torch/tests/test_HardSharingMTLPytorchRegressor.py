...
class TestHardSharingMTLPytorchRegressor(unittest.TestCase):
    def setUp(self):
        ...
        self.model = HardSharingMTLPytorchRegressor(common_module=self.module,
                                               epochs=self.epochs,
    ...
    #     model = HardSharingMTLPytorchRegressor(common_module=NeuralNetwork, 
