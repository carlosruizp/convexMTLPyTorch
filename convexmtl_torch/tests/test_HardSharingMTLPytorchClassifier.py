...
class TestHardSharingMTLPytorchClassifier(unittest.TestCase):
    def setUp(self):
    ...
    def test_fit_tabular(self):
        model = HardSharingMTLPytorchClassifier(common_module=NeuralNetworkFeatLearn, train_mode='lightning', epochs=self.epochs)
    ...
    def test_fit_image(self):
        model = HardSharingMTLPytorchClassifier(common_module=ConvNetFeatLearn, epochs=self.epochs)
