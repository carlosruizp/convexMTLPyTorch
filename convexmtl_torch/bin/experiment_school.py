...
def get_estim(estim_name, task=None, progress_bar=False):
    ...
    if strategy == 'hs':
        estim = HardSharingMTLPytorchRegressor(enable_progress_bar=progress_bar)
    elif strategy == 'cvx':
        estim = ConvexMTLPytorchRegressor(lambda_trainable=True, specific_lambda=False, enable_progress_bar=progress_bar)
    elif strategy == 'gl':
        estim = GraphLaplacianMTLPytorchRegressor(adj_trainable=True, enable_progress_bar=progress_bar)
    elif strategy == 'common':
        estim = ConvexMTLPytorchRegressor(lambda_trainable=False, specific_lambda=False, lamb=1, enable_progress_bar=progress_bar)
    elif strategy == 'ind':
        estim = ConvexMTLPytorchRegressor(lambda_trainable=False, specific_lambda=False, lamb=0, enable_progress_bar=progress_bar)
